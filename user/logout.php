...
$deactivate_tablet = "UPDATE tabletactivate_tbl SET tab_order = 'Order Complete' WHERE o_id = '$orderid' AND tab_sess = '$crt_sess' AND o_activation = '$activation' AND tab_active = '1'";
